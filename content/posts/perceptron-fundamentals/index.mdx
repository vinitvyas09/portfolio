...
# The Perceptron: Where Deep Learning Begins
...
<Math title="The Perceptron Equation" boxed>
...
<Math title="Weight Update Rule" collapsible>
...
<References 
  items={[
    ...
    {
      title: "Neural Networks Playlist",
      url: "https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi",
      author: "3Blue1Brown",
      type: "video"
    },
    {
      title: "Perceptron Implementation from Scratch",
      url: "https://github.com/sebtheiler/tutorials/blob/main/perceptron/perceptron.py",
