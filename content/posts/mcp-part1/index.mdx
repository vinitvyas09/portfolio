...
It is not that there were zero solutions to this: Teams tried bespoke adapters, brittle middle layers and vendor-specific plugins (OpenAI had one too, which it later cancelled). It worked in demos and failed at scale whereas the M×N explosion made integration costs grow nonlinearly.
