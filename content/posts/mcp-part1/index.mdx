...
In November 2024, Anthropic released their solution. The official definition: "MCP (Model Context Protocol) is an open-source standard for connecting AI applications to external systems". Here is how it works: it defines a few things:  
...
We will focus on this more in part 2, but I just wanted to provide a taste for how this architecture is conceptualized.
