...
The perceptron isn't obsolete history. It's the hydrogen atom of artificial intelligence where the simplest possible unit that exhibits the behavior we're interested in. And just as understanding hydrogen helps explain stars, understanding the perceptron explains why machines can now see, read, and create.
Simple ideas aren't less important as systems get more complex. They become more important, because they're the only solid ground in a sea of complexity. The li'l perceptron, which we spent a lot of time looking at, is that solid ground.
