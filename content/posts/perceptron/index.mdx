...
{/*
<VotedPerceptronDiagram
config={{
showWeightHistory: true,
exampleVotes: [
{weights: [0.2, 0.3], survivalTime: 50, vote: "+50"},
{weights: [0.5, -0.1], survivalTime: 300, vote: "+300"},
{weights: [2.1, 0.8], survivalTime: 1, vote: "-1"},
{weights: [1.9, 0.7], survivalTime: 150, vote: "+150"}
],
totalVote: "+499 → Positive"
}}
/>
*/}
...
Kudos on making it this far! Apreciate the time you spent here. I hope it helps that the perceptron isn't obsolete history. It's the hydrogen atom of artificial intelligence which explains the simplest possible unit that exhibiting the behavior we're interested in. And just as understanding hydrogen helps explain stars, understanding the perceptron explains why machines can now see, read, and create. Simple ideas aren't less important as systems get more complex. They become more important, because they're the only solid ground in a sea of complexity. The li'l perceptron, which we spent a lot of time looking at, is that solid ground.
