...
<p className="text-sm text-gray-600 text-center mt-2 italic">Good luck "eyeballing" a separating hyperplane in 50,000 dimensions!</p>
...
{/* TODO: Implement InfoBox component
