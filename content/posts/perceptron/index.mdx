...
no need to create a new component here. maybe just reuse linear-separable-data-viz component but where the 'train perceptron' button is present but on by default, and it goes in a loop
