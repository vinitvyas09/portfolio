...
<!-- TODO: Insert animation that is a split-screen morph showing a biological neuron gradually transforming into circuit diagrams, then into mathematical notation, then into code, then into a chat interface where someone asks an LLM to recite a haiku on a 986 Boxster and the model obliges—emphasizing the "it's all the same thing" revelation. -->
...
<!-- TODO: Replace with <NeuronAnimation /> once the component exists.
NeuronAnimation config={{
inputs: 5,
showWeights: true,
fireThreshold: 0.7,
animationMs: 3000,
...
<!-- TODO: Insert photo of Mark 1 perceptron rig. -->
...
NeuronVsPerceptron config={{ side: "split", animateTransition: true, showLabels: true, neuronLabels: ["Dendrites", "Cell Body", "Axon", "Chemical Signals"], perceptronLabels: ["Inputs (x₁, x₂...)", "Weighted Sum", "Activation Function", "Output"], transitionMs: 2000 }}
-->
